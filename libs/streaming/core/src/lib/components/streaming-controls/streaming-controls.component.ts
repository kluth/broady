      ...
      <div class="control-row">
        ...
        <div class="control-group">
          @if (!isStreaming()) {
            ...
            <button
              class="btn-control btn-stop-stream"
              (click)="stopStreaming()"
            >
              <span class="icon">⏹</span>
              Stop Streaming
          ...
          @if (isStreaming()) {
            <div class="stream-stats">
              ...
              <span class="stat">
                ...
                <span class="stat-value">{{ streamStats().bitrate | number:'1.0-0' }} kbps</span>
              </span>
              <span class="stat">
        ...
        <div class="control-group">
          @if (!isRecording()) {
            ...
            <button
              class="btn-control btn-stop-record"
              (click)="stopRecording()"
            >
              <span class="icon">⏹</span>
              Stop Recording
        ...
        <div class="control-group">
          @if (replayBufferEnabled()) {
            <button
              class="btn-control btn-save-replay"
              (click)="saveReplay()"
            >
              <span class="icon">💾</span>
              Save Replay
